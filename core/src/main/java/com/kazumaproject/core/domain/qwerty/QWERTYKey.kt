...
sealed class QWERTYKey {
    ...
    data object QWERTYKeySymbol1 : QWERTYKey()
    data object QWERTYKeySymbol2 : QWERTYKey()
    data object QWERTYKeySymbol3 : QWERTYKey()
    data object QWERTYKeySymbol4 : QWERTYKey()
    data object QWERTYKeySymbol5 : QWERTYKey()
    data object QWERTYKeySymbol6 : QWERTYKey()
    data object QWERTYKeySymbol7 : QWERTYKey()
    data object QWERTYKeySymbol8 : QWERTYKey()
    data object QWERTYKeySymbol9 : QWERTYKey()
    data object QWERTYKeySymbol10 : QWERTYKey()
