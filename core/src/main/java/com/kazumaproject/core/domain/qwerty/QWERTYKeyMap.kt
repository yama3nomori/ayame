...
class QWERTYKeyMap : QWERTYKeyMapHolder {
    ...
    private val listDefault: Map<QWERTYKey, QWERTYKeyInfo> = mapOf(
        ...
        QWERTYKey.QWERTYKey4 to QWERTYKeyInfo.KeyUnderscore,
        QWERTYKey.QWERTYKey5 to QWERTYKeyInfo.KeyColon,
        ...
        QWERTYKey.QWERTYKey9 to QWERTYKeyInfo.KeyQuestion,
    ...
    private val listDefaultJP: Map<QWERTYKey, QWERTYKeyInfo> = mapOf(
        ...
        QWERTYKey.QWERTYKeyAtMark to QWERTYKeyInfo.KeyMinusJP,
        QWERTYKey.QWERTYKeyL to QWERTYKeyInfo.KeyLJP,
